// WiFi shield, Groove ultrasonic SEN136B5B to D6
...
Ultrasonic ultrasonic(6); // digital pin of ultrasonic sensor
...
void measure() {
  ...
  currentPayloadValue1 = ultrasonic.microsecondsToCentimeters();//convert the time to centimeters
}
